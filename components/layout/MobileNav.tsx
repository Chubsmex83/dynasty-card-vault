        ...
        {open ? (
          ...
          >
            ...
            <motion.div
              ...
              aria-modal="true"
              className={cn(
                'absolute right-0 top-0 flex h-full w-[86%] max-w-sm flex-col gap-6 border-l border-gold/20 bg-panel p-6 shadow-2xl'
              )}
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  onClick={() => setOpen(false)}
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 text-muted transition-colors hover:text-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold"
                >
                  <CloseIcon />
                </button>
              </div>

              <SearchBar locale={locale} dict={dict} onNavigate={() => setOpen(false)} />
